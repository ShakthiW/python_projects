#Author - Shakthi Raveen
#Date - 14th Oct. 2022

#Python mad libs  generator

#import thinker library
from tkinter import *

#Initiate thinker and create a window
root = Tk()
root.title("Mad Libs Generator")
root.geometry('300x300')

#adding widgets
Label(root, text='Mad Libs generator \n Have Fun!', font='areal 20 bold').pack()
Label(root, text='Click anyone : ', font='areal 15 bold').place(x=40, y=80)
...
def madlib1():
    ...
    print('say ' + food + ', the photographer said as the camera flashed! ' + name + ' and I had gone to ' + place
           +' to get our photos taken on my birthday. The first photo we really wanted was a picture of us dressed as ' + animals + ' pretending to be a '
           + profession + '. when we saw the second photo, it was exactly what I wanted. We both looked like ' + things
...
def madlib2():
    ...
    print('Last night I dreamed I was a ' +adjactive+ ' butterfly with ' + color+ ' splocthes that looked like '+thing+
          ...
          ' who was a '+adjactive1+ ' ' +insect +' .We ate some ' +food+ ' when we got there and then decided to '+verb+
...
#Add buttons
Button(root, text='The photographer', font='areal 15', )
